...
for diagnosis in all_HIA_diagnosis:
    #worksheet = new_workbook.create_sheet(title=str(tracker))
    #new_workbook.save()
    # worksheet1 = new_workbook[str(tracker)]
